...
app.controller("pokeCtrl", function($scope) {
	...
	$scope.getPokemonObject= function(number, pokename){
		console.log("loading...");
		current_id = number;
		var full = "https://pokeapi.salestock.net/api/v2/pokemon/"+number;
	...
	function getAllPokemon(){
		...
		var full = "https://pokeapi.salestock.net/api/v2/pokedex/1/";
	...
	{
		var full = "https://pokeapi.salestock.net/api/v2/pokemon-species/"+id;
